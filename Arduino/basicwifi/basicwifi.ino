const char* ssid = "NETWORK NAME";          // WIFI network SSID or AP SSID
...
int port =80;
const char* serverIP = "192.168.1.72";       // The three first numbers have to be the same with the router IP
...
void connectToWiFiNetwork(){
    ...
    //--- connect
    espSerial.println("AT+CWJAP=\"LavatanssitIsBack\",\"Koivusalo56\"");
...
void virtuinoRun(){
     if(espSerial.available()){
       ...
       String espBuffer = espSerial.readStringUntil('\r');
          ...
          {    
              LED_state = !LED_state; // Change LED status 
